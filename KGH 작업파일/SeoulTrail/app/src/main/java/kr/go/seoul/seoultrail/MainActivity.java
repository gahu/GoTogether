...
public class MainActivity extends TabActivity {
    ...
    final static String COMMUNITY = "4";
    final static String SEOULTRAIL = "5";
    final static String MENU = "1";
...
//    private TextView checkNMapMyLocation;
    ...
    private void initView() {
        ...
        setupTab(SEOULTRAIL);
        setupTab(MENU);
        //tabHost.setCurrentTab(1);           // 현재 탭 2번째것이 들어가게함. INFO부분 !
    ...
    private void setupTab(final String tag) {
        ...
        if (tag.equals(COURSE))
            ...
            setContent.setContent(new Intent(this, MenuActivity.class));
        else if (tag.equals(VIDEO))
