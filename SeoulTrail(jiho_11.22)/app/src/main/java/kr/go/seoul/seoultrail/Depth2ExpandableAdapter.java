...
public class Depth2ExpandableAdapter extends BaseExpandableListAdapter {
    private Context context;
    private List<String> depth2ExpandableListTitle;
    private HashMap<String, String> depth2ExpandableListDetail;

    public Depth2ExpandableAdapter(Context context, List<String> depth2ExpandableListTitle, HashMap<String, String> depth2ExpandableListDetail) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.depth2_group, null);
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = inflater.inflate(R.layout.depth2_child, null);
        }
