...
//    private TextView checkNMapMyLocation;
    ...
    private void initView() {
        ...
        headerImageLayout = (LinearLayout) findViewById(R.id.headerImage_layout);
        ...
        tabHost.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String tag) {
                ...
                if (tag.equals(COURSE)) {
                    headerImage.setImageResource(R.drawable.bar_icon01_off_yungyu);
                    headerTitle.setText("둘레길 코스");
                    lastTabTag = COURSE;
                    loggingAction = "COURSE";
                } else if (tag.equals(INFO)) {
                    headerTitle.setText("둘레길 안내");
                    headerImage.setImageResource(R.drawable.bar_icon02_off);
                    lastTabTag = INFO;
                    loggingAction = "INFO";
                    btnGuide.setVisibility(View.VISIBLE);
                } else if (tag.equals(VIDEO)) {
                    headerImage.setImageResource(R.drawable.bar_icon03_off);
                    lastTabTag = VIDEO;
                    loggingAction = "VIDEO";
                } else if (tag.equals(DAUMCAFE)) {
                    headerTitle.setText("둘레길 카페");
                    headerImage.setImageResource(R.drawable.bar_icon01_on_yungyu);
...
//                }
    ...
    private void setupTab(final String tag) {
        ...
        if (tag.equals(COURSE))
            setContent.setContent(new Intent(this, TabHost_FirstTab.class));
        else if (tag.equals(INFO))
            setContent.setContent(new Intent(this, Information.class));
        else if (tag.equals(VIDEO))
            setContent.setContent(new Intent(this, FaQ.class));
        else if (tag.equals(DAUMCAFE)) {
...
//        }
    ...
    private static View createTabView(final Context context, final String text) {
        ...
        if (text.equals(COURSE)) {
            img.setImageResource(R.drawable.btn01_main_off);
        } else if (text.equals(INFO)) {
            img.setImageResource(R.drawable.btn02_course_on);
        } else if (text.equals(VIDEO)) {
            img.setImageResource(R.drawable.btn03_community_off);
        } else if (text.equals(DAUMCAFE)) {
            img.setImageResource(R.drawable.btn04_camera_off);
        }
