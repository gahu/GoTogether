...
public class NMapPOIflagType {
    ...
    public static final int SAFESPOT = PIN + 1;
    public static final int ROUTE1 = SAFESPOT + 1;
    public static final int ROUTE2 = ROUTE1 + 1;
    public static final int ROUTE3 = ROUTE2 + 1;
    public static final int ROUTE4 = ROUTE3 + 1;
    public static final int ROUTE5 = ROUTE4 + 1;
    public static final int ROUTE6 = ROUTE5 + 1;
    public static final int ROUTE7 = ROUTE6 + 1;
    public static final int ROUTE8 = ROUTE7 + 1;
